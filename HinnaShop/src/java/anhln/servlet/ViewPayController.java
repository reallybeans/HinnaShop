 ...
 * @author leean
 */
public class ViewPayController extends HttpServlet {

    Logger loger = Logger.getLogger(ViewPayController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            float price1 = Float.parseFloat(total1);
            ...
            loger.error("Error at ViewPayController: " + e.toString());
        } finally {
