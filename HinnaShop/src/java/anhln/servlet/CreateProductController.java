...
public class CreateProductController extends HttpServlet {
    ...
    Logger loger = Logger.getLogger(CreateProductController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductDTO pro = new ProductDTO(productID, productName, quanlity, description, cateID, price, myImage);
            boolean checkPro = dao.createPro(pro);
            if (checkPro != true) {
                request.setAttribute("DULICATED", "OMG!");
            } else {
                url = SUCCESS;
            }
        } catch (NumberFormatException | SQLException e) {
            loger.error("Error at CreateProductController: " + e.toString());
